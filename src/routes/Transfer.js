          ...
          <div className="row">
            <div className="col-12 col-lg-7">
              <div className="section">
                <p>
                Move funds to another EOS account.
                </p>
                <TransferForm />
              </div>
              <div className="section">
            ...
            <div className="col-12 col-lg-5">
              ...
              <div className="module">
                <p>
                  EOS tokens are ERC-20 compatible tokens distributed on the Ethereum blockchain
                   pursuant to a related ERC-20 smart contract (the “EOS Tokens”).
                </p>
              </div>
              <h5>
              How can I use EOS tokens?
              </h5>
              <div className="module">
                <p>
                block.one is building the EOS.IO Software but it will not configure and/or
